...
func init() {
	...
	startCmd.PersistentFlags().StringVar(&startOpts.metricsURL, "metrics-url", "127.0.0.1:8080", "URL for metrics listener")
}
...
func runStartCmd(cmd *cobra.Command, args []string) {
	...
	go daemon.StartMetricsListener(startOpts.metricsURL)
